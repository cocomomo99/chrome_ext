...
exports.MessagesV1Beta3Client = void 0;
 ...
 */
const gapicConfig = require("./messages_v1_beta3_client_config.json");
...
class MessagesV1Beta3Client {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listJobMessages: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'jobMessages'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.dataflow.v1beta3.MessagesV1Beta3', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.messagesV1Beta3Stub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.dataflow.v1beta3.MessagesV1Beta3')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.dataflow.v1beta3.MessagesV1Beta3, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const messagesV1Beta3StubMethods = ['listJobMessages'];
        for (const methodName of messagesV1Beta3StubMethods) {
            const callPromise = this.messagesV1Beta3Stub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listJobMessages(request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        let options;
    ...
    listJobMessagesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listJobMessages.createStream(this.innerApiCalls.listJobMessages, request, callSettings);
    }
    /**
    ...
    listJobMessagesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listJobMessages.asyncIterate(this.innerApiCalls['listJobMessages'], request, callSettings);
    }
    /**
...
exports.MessagesV1Beta3Client = MessagesV1Beta3Client;
//# sourceMappingURL=messages_v1_beta3_client.js.map