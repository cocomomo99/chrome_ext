...
exports.SnapshotsV1Beta3Client = void 0;
 ...
 */
const gapicConfig = require("./snapshots_v1_beta3_client_config.json");
...
class SnapshotsV1Beta3Client {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.dataflow.v1beta3.SnapshotsV1Beta3', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.snapshotsV1Beta3Stub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.dataflow.v1beta3.SnapshotsV1Beta3')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.dataflow.v1beta3.SnapshotsV1Beta3, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of snapshotsV1Beta3StubMethods) {
            const callPromise = this.snapshotsV1Beta3Stub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSnapshot(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                snapshot_id: (_c = request.snapshotId) !== null && _c !== void 0 ? _c : '',
            });
        this.initialize();
...
exports.SnapshotsV1Beta3Client = SnapshotsV1Beta3Client;
//# sourceMappingURL=snapshots_v1_beta3_client.js.map