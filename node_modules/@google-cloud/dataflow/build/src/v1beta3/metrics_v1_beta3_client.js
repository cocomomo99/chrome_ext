...
exports.MetricsV1Beta3Client = void 0;
 ...
 */
const gapicConfig = require("./metrics_v1_beta3_client_config.json");
...
class MetricsV1Beta3Client {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            getJobExecutionDetails: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'stages'),
            getStageExecutionDetails: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'workers'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.dataflow.v1beta3.MetricsV1Beta3', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.metricsV1Beta3Stub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.dataflow.v1beta3.MetricsV1Beta3')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.dataflow.v1beta3.MetricsV1Beta3, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of metricsV1Beta3StubMethods) {
            const callPromise = this.metricsV1Beta3Stub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getJobMetrics(request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        let options;
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                location: (_b = request.location) !== null && _b !== void 0 ? _b : '',
                job_id: (_c = request.jobId) !== null && _c !== void 0 ? _c : '',
            });
        this.initialize();
        return this.innerApiCalls.getJobMetrics(request, options, callback);
    }
    getJobExecutionDetails(request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.getJobExecutionDetails(request, options, callback);
    }
    /**
    ...
    getJobExecutionDetailsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.getJobExecutionDetails.createStream(this.innerApiCalls.getJobExecutionDetails, request, callSettings);
    }
    /**
    ...
    getJobExecutionDetailsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.getJobExecutionDetails.asyncIterate(this.innerApiCalls['getJobExecutionDetails'], request, callSettings);
    }
    getStageExecutionDetails(request, optionsOrCallback, callback) {
        var _a, _b, _c, _d;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                ...
                location: (_b = request.location) !== null && _b !== void 0 ? _b : '',
                job_id: (_c = request.jobId) !== null && _c !== void 0 ? _c : '',
                stage_id: (_d = request.stageId) !== null && _d !== void 0 ? _d : '',
            });
        this.initialize();
        return this.innerApiCalls.getStageExecutionDetails(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    getStageExecutionDetailsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.getStageExecutionDetails.createStream(this.innerApiCalls.getStageExecutionDetails, request, callSettings);
    }
    /**
    ...
    getStageExecutionDetailsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.getStageExecutionDetails.asyncIterate(this.innerApiCalls['getStageExecutionDetails'], request, callSettings);
    }
    /**
...
exports.MetricsV1Beta3Client = MetricsV1Beta3Client;
//# sourceMappingURL=metrics_v1_beta3_client.js.map